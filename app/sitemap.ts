...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE_URL}/my-angel-number`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/angel-compatibility`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/today-angel-number`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    ...
    { url: `${BASE_URL}/column/angel-6666`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE_URL}/column/angel-8888`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
