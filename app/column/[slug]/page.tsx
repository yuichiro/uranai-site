...
const FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  "angel-6666": [
    { q: "エンジェルナンバー6666は不吉ですか？", a: "いいえ。6666は不吉なサインではありません。愛・調和・バランスを取り戻すよう促す天使からのあたたかいメッセージで、恐れる必要はまったくありません。" },
    { q: "6666と666の違いは何ですか？", a: "666はバランスへの気づきを促すやさしいサイン、6666はそのメッセージが強調された、より強く明確なサインです。今こそ心と生活のバランスを本気で整えるタイミングを示します。" },
    { q: "6666を繰り返し見るのはなぜですか？", a: "仕事・お金・人間関係の心配で思考が偏りすぎているサインです。天使が「愛とバランスを取り戻せば道は開ける」と強く伝えています。" },
  ],
  "angel-8888": [
    { q: "エンジェルナンバー8888の意味は？", a: "8888は豊かさ・成功・金運が本格的に実現する、最強クラスのサインです。これまでの努力が大きく実を結び、チャンスがまとまって訪れる前兆です。" },
    { q: "8888と888の違いは？", a: "888は豊かさが流れ込む「入口」のサイン、8888は豊かさが本格的に「実現・拡大」するより大きなサインで、人生の飛躍や大きな転換点を示します。" },
    { q: "8888を見るのは何の前兆ですか？", a: "人生が大きく飛躍する前兆です。臨時収入・昇進・独立の成功・大きなチャンスの到来など、うれしい出来事がまとまって近づいているサインです。" },
  ],
  "angel-1111": [
    ...
    { q: "エンジェルナンバー1111は運命の人との出会いのサインですか？", a: "はい。1111は運命の人やソウルメイトとの縁が近づくサインとされます。まず自分の心を整え、ありのままの自分でいることが良い出会いを引き寄せる鍵です。" },
    { q: "「1111 病気」と出るのはなぜ？体調が悪くなる前兆ですか？", a: "1111は病気を予告する数字ではありません。「心と体のバランスを整えて」というセルフケアのサインです。なお体調の不安は占いに頼らず、必ず医療機関にご相談ください。" },
    { q: "1111を頻繁に見るのはどういう意味ですか？", a: "天使が強くあなたの注意を引こうとしているサインで、「もうすぐ変化や願いの実現が近い」という前兆と解釈されます。今の思考を望む方向へ整えましょう。" },
  ],
};
